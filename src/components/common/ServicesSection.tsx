...
const modelingServices = [
  {
    ...
    description:
      "Professional runway and editorial modeling for fashion brands, designers, and magazines.",
    url: "/services/fashion.jpeg",
  },
  {
    title: "Commercial Modeling",
    description:
      "Modeling for advertisements, TV commercials, billboards, and product promotions.",
    url: "/services/commercial.jpeg",
  },
  {
    title: "Fitness Modeling",
    description:
      "Showcasing athletic and sports-related apparel, fitness gear, and health brands.",
    url: "/services/fitness.jpeg",
  },
  {
    title: "Glamour Modeling",
    description:
      "Focused on aesthetic appeal, beauty, and high-end photography for magazines and promotions.",
    url: "/services/glamour.jpeg",
  },
  {
    title: "Parts Modeling",
    description:
      "Specialized modeling for hands, feet, eyes, or other body parts for advertisements and brands.",
    url: "/services/parts.jpeg",
  },
  {
    title: "Swimwear & Lingerie Modeling",
    description:
      "Modeling swimwear, lingerie, and intimate apparel for brands and advertising campaigns.",
    url: "/services/swimwear.jpeg",
  },
  {
    title: "Plus-Size Modeling",
    description:
      "Body-positive modeling for plus-size clothing brands and inclusive fashion campaigns.",
    url: "/services/plussize.jpeg",
  },
  {
    title: "E-commerce & Catalog Modeling",
    description:
      "Professional modeling for online stores, print catalogs, and digital fashion lookbooks.",
    url: "/services/catalog.jpeg",
  },
  {
    title: "Editorial & High Fashion Modeling",
    description:
      "Avant-garde and creative modeling for high-end fashion magazines and luxury brands.",
      ...
      <Box id="services">
        <Box
          sx={[
            (theme) => ({
              backgroundImage:
                "linear-gradient(to right bottom, #d16ba5, #c777b9, #ba83ca, #aa8fd8, #9a9ae1, #9c98e4, #9e95e6, #a193e8, #bf7ddc, #dd61c3, #f43e9d, #ff006e)",
