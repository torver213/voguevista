          ...
          <Grid2 size={{ lg: 6, md: 6, sm: 12, xs: 12 }}>
            ...
            <Slide duration={1100} direction="left">
              <Typography variant="subtitle2" sx={{ pb: 2 }}>
                ...
                lifestyle, and an ever-evolving art form. Our expertise blends
                creativity with technology to build visually compelling fashion
                brands that stand out in the digital world.
              </Typography>
            </Slide>
            <Slide duration={1300} direction="left">
              <Typography variant="body2">
                From luxury editorial shoots to trendsetting campaigns, we
                design high-quality imagery and branding solutions that capture
                the essence of style and sophistication.
              </Typography>
            </Slide>
            <Slide duration={1500} direction="left">
              <Typography variant="body2">
                Whether it&apos;s haute couture or streetwear, we ensure your
                fashion brand makes a lasting impression with visually striking
